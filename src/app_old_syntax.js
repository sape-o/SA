...
class InsertRating extends React.Component {
  ...
  renderToolbar() {
    return (
      <Ons.Toolbar>
         <div className='center'>ประเมิน</div>
          <div className='left'><Ons.BackButton>Back</Ons.BackButton></div>
          <div className='right'>
...
class Rating extends React.Component {
  ...
  showMenu() {
    ...
    pushPage2() {
      this.props.navigator.pushPage({ component: Result, props: { key: 'Result'} });
    }
   ...
   renderRow(row,index) {
    ...
    <center>
      <Ons.Card style={{width: '80%'}}
          ...
          <center>{ใส่ ID Employee}</center>//////////////////
          </td>
          <td style={{width:'200px'}}>
          <center>{row.pemployee.firstName}</center>
          </td>
          <td style={{width:'200px'}}>
          <center>{row.pemployee.lastName}</center>
          </td>
          <td style={{width:'160px'}}>
          <center>{row.pemployee.id_card_NO}</center>
          </td>
          <td style={{width:'160px'}}>
  ...
  render() {
    return (
      <Ons.Page renderToolbar={this.renderToolbar.bind(this)}>
        ...
        <td style={{width:'160px'}}><center>เลขประจำตัวประชาชน</center></td>
