...
class RepairInvoice extends React.Component {
    ...
    handleClick(firstName,lastName,tel) {
      return function () {
          client({method: 'GET', path: '/firstName/'+firstName+'/lastName/'+lastName+'/tel/'+tel}).done(
  ...
  {/*เลือกพนักงานซ่อม------------------------------------------------------------------*/} 
          ...
          <div style={{ textAlign: 'center', paddingTop:'10px', paddingBottom:'10px'}}>
            ...
            <Ons.Button onClick={this.handleClick('Watsamon','Pongsupan','0874563800')}>
                บันทึกข้อมูล
            </Ons.Button>
          </div>
